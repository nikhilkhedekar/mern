      ...
      .then((result) => {
        if (result.error) {
          ...
          postRequest(`/payment/confirm`, {
            paymentMethod: "pm_card_visa",//paymentMethod.id,
            paymentIntent: "pi_3LZvkMSJ4PPLl4fc0cw9QQX8"//paymentIntent.id,
          })
            .then((resp) => {
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <div 
            // className={clsx(style.row, style.col)}
            >
              <div 
